...
import type { PointerEventData, KeyboardEventData, LineShape } from '../types';
...
export class LineTool extends Tool {
  ...
  onKeyDown(event: KeyboardEventData, context: ToolContext): void {
    // Escape cancels in-progress line drawing
  ...
  renderOverlay(ctx: CanvasRenderingContext2D, _context: ToolContext): void {
    ...
    if (this.currentShape) {
      // Render preview of current line
